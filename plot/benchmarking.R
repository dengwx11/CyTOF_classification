...
write.table(pars_s1, '/Users/mac/Desktop/Yale/Hongyu/CyTOF/bcmk/bcmk_s1.txt')
write.table(pars_s2, '/Users/mac/Desktop/Yale/Hongyu/CyTOF/bcmk/bcmk_s2.txt')
write.table(pars_s3, '/Users/mac/Desktop/Yale/Hongyu/CyTOF/bcmk/bcmk_s3.txt')
write.table(pars_s4, '/Users/mac/Desktop/Yale/Hongyu/CyTOF/bcmk/bcmk_s4.txt')
write.table(pars_s5, '/Users/mac/Desktop/Yale/Hongyu/CyTOF/bcmk/bcmk_s5.txt')
write.table(pars_s6, '/Users/mac/Desktop/Yale/Hongyu/CyTOF/bcmk/bcmk_s6.txt')

pars_s1 <- read.table('/Users/mac/Desktop/Yale/Hongyu/CyTOF/bcmk/bcmk_s1.txt')
pars_s2 <- read.table('/Users/mac/Desktop/Yale/Hongyu/CyTOF/bcmk/bcmk_s2.txt')
pars_s3 <- read.table('/Users/mac/Desktop/Yale/Hongyu/CyTOF/bcmk/bcmk_s3.txt')
pars_s4 <- read.table('/Users/mac/Desktop/Yale/Hongyu/CyTOF/bcmk/bcmk_s4.txt')
pars_s5 <- read.table('/Users/mac/Desktop/Yale/Hongyu/CyTOF/bcmk/bcmk_s5.txt')
pars_s6 <- read.table('/Users/mac/Desktop/Yale/Hongyu/CyTOF/bcmk/bcmk_s6.txt')

pars_s1$models <- factor(pars_s1$models,levels = c("NNLS", "Louvain", "w/o A0 AS", "w/o A0", "w/o AS", "Full"))
pars_s1$metric <- factor(pars_s1$metric,levels = c('ASW', 'Cosine Similarity', 'NMI', 'Accuracy', 'ARI'))
pars_s2$models <- factor(pars_s2$models,levels = c("NNLS", "Louvain", "w/o A0 AS", "w/o A0", "w/o AS", "Full"))
pars_s2$metric <- factor(pars_s2$metric,levels = c('ASW', 'Cosine Similarity', 'NMI', 'Accuracy', 'ARI'))
pars_s3$models <- factor(pars_s3$models,levels = c("NNLS", "Louvain", "w/o A0 AS", "w/o A0", "w/o AS", "Full"))
pars_s3$metric <- factor(pars_s3$metric,levels = c('ASW', 'Cosine Similarity', 'NMI', 'Accuracy', 'ARI'))
pars_s4$models <- factor(pars_s4$models,levels = c("NNLS", "Louvain", "w/o A0 AS", "w/o A0", "w/o AS", "Full"))
pars_s4$metric <- factor(pars_s4$metric,levels = c('ASW', 'Cosine Similarity', 'NMI', 'Accuracy', 'ARI'))
pars_s5$models <- factor(pars_s5$models,levels = c("NNLS", "Louvain", "w/o A0 AS", "w/o A0", "w/o AS", "Full"))
pars_s5$metric <- factor(pars_s5$metric,levels = c('ASW', 'Cosine Similarity', 'NMI', 'Accuracy', 'ARI'))
pars_s6$models <- factor(pars_s6$models,levels = c("NNLS", "Louvain", "w/o A0 AS", "w/o A0", "w/o AS", "Full"))
pars_s6$metric <- factor(pars_s6$metric,levels = c('ASW', 'Cosine Similarity', 'NMI', 'Accuracy', 'ARI'))
