...
saveRDS(rst,paste0('/gpfs/ysm/pi/zhao-data/wd262/new_cytof/write/BCR/',ct.cnt,'celltype/rst_',sample,".rds"))
saveRDS(seur,paste0('/gpfs/ysm/pi/zhao-data/wd262/new_cytof/write/BCR/',ct.cnt,'celltype/seur_',sample,".rds"))
